...
"""
#handling M/EEG data
stcEEG = mne.read_source_estimate(inv_dir / "task-facerecognition_cond-famous_fwd-mne_ch-eeg_split-0_stc")
print("The shape of the M/EEG data is: ", stcEEG.data.shape)
#the orginal morpher which is used on M/EEG data
orgMorph = mne.read_source_morph(fwd_dir / "task-facerecognition_fwd-mne_morph.h5")
orgMorph.apply(stcEEG)
print("The shape of the M/EEG data after morph is: ", stcEEG.data.shape)

#handling fMRI data
stcFMRI = mne.read_source_estimate(fmri_dir / "surf_sasub-01_ses-mri_task-facerecognition_run-01_bold")
print("The shape of the fMRI data is: ", stcFMRI.data.shape)
#new type of morpher which is used on fMRI data
newMorph = mne.read_source_morph("Testmorpher-morph.h5")
newMorph.apply(stcFMRI)
print("The shape of the fMRI data after morph is: ", stcFMRI.data.shape)
"""
