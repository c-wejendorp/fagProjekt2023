...
#             continue
#         reg_result_means, LR_pca_gen_acc = train_all(archetypes=archetype, seed=seed, reg_params=reg_params, modalityComb=modalityComb, datapath=datapath)
...
#     f.close()
    ...
    LR_pca_loss = {'10': [0.44791666666666663, 0.47916666666666663, 0.45833333333333326, 0.46875, 0.46875, 0.49999999999999994, 0.4583333333333333, 0.5104166666666666, 0.47916666666666663, 0.46874999999999994]}
    LR_reg_ploss = {'10': {0.01: [0.4583333333333333, 0.44791666666666663, 0.47916666666666663, 0.46875, 0.44791666666666663, 0.44791666666666663, 0.4375, 0.41666666666666663, 0.44791666666666663, 0.46875], 0.0001: [0.44791666666666663, 0.4583333333333333, 0.46875, 0.45833333333333326, 0.42708333333333326, 0.45833333333333326, 0.44791666666666663, 0.44791666666666663, 0.3958333333333333, 0.4270833333333333]}}
