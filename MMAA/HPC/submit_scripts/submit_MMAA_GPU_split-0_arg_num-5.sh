            ...
            #BSUB -J MMAA_train_split-0_arg_num-5
            #BSUB -o MMAA_train_split-0_arg_num-5_%J.out
            #BSUB -e MMAA_train_split-0_arg_num-5_J.err
            ...
            python MMAA/HPC/trainModels.py 0 5
