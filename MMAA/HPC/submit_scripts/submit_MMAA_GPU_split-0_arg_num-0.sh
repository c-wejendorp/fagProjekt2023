            ...
            #BSUB -J MMAA_train_split-0_arg_num-0
            #BSUB -o MMAA_train_split-0_arg_num-0_%J.out
            #BSUB -e MMAA_train_split-0_arg_num-0_J.err
            ...
            python MMAA/HPC/trainModels.py 0 0
