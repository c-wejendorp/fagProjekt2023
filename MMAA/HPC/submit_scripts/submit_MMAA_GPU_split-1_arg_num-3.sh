            ...
            #BSUB -J MMAA_train_split-1_arg_num-3
            #BSUB -o MMAA_train_split-1_arg_num-3_%J.out
            #BSUB -e MMAA_train_split-1_arg_num-3_J.err
            ...
            python MMAA/HPC/trainModels.py 1 3
