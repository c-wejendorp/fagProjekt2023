            ...
            #BSUB -J MMAA_train_split-1_arg_num-1
            #BSUB -o MMAA_train_split-1_arg_num-1_%J.out
            #BSUB -e MMAA_train_split-1_arg_num-1_J.err
            ...
            python MMAA/HPC/trainModels.py 1 1
