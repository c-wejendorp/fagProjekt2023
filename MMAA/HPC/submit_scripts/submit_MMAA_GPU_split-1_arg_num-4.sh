            ...
            #BSUB -J MMAA_train_split-1_arg_num-4
            #BSUB -o MMAA_train_split-1_arg_num-4_%J.out
            #BSUB -e MMAA_train_split-1_arg_num-4_J.err
            ...
            python MMAA/HPC/trainModels.py 1 4
