            ...
            #BSUB -J MMAA_train_split-1_arg_num-2
            #BSUB -o MMAA_train_split-1_arg_num-2_%J.out
            #BSUB -e MMAA_train_split-1_arg_num-2_J.err
            ...
            python MMAA/HPC/trainModels.py 1 2
