            ...
            #BSUB -J MMAA_train_split-0_arg_num-6
            #BSUB -o MMAA_train_split-0_arg_num-6_%J.out
            #BSUB -e MMAA_train_split-0_arg_num-6_J.err
            ...
            python MMAA/HPC/trainModels.py 0 6
