...
#bsub < MMAA/HPC/submit_scripts/submit_MMAA_GPU_split-0_arg_num-4.sh
#bsub < MMAA/HPC/submit_scripts/submit_MMAA_GPU_split-0_arg_num-5.sh
#bsub < MMAA/HPC/submit_scripts/submit_MMAA_GPU_split-0_arg_num-6.sh
...
#bsub < MMAA/HPC/submit_scripts/submit_MMAA_GPU_split-1_arg_num-4.sh
#bsub < MMAA/HPC/submit_scripts/submit_MMAA_GPU_split-1_arg_num-5.sh
#bsub < MMAA/HPC/submit_scripts/submit_MMAA_GPU_split-1_arg_num-6.sh
