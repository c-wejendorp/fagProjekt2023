...
#BSUB -J Archetype_plot
#BSUB -o Archetype_plot_%J.out
#BSUB -e Archetype_plot_%J.err
...
#BSUB -R "span[hosts=1]"
### -- specify that we need 32GB of Memory  more than enough for this task
